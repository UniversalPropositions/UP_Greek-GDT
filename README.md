...
- `git clone https://github.com/UniversalPropositions/UP_Greek-GDT.git`
...
- `python3 up2/merge_ud_up.py --input_ud=<ud_path_to_UD_Greek-GDT>/ --input_up=<up_path_to_UP_Greek-GDT>/ --output=<path_to_UD+UP_Greek-GDT>/`
